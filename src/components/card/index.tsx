...
export function Card({product}:ProductProps){
    return(
            ...
            <div 
            className='flex flex-col w-full overflow-hidden bg-sky-200 rounded-t-md rounded-b-2xl mt-12'
            >
                <img
                className='object-cover border-b-2 border-slate-600 hover:scale-110'
